...
if [ -n "$1" ]; then
    ...
    rm -f ir.txt
    PASS=0 FAIL=0
    for f in test/add.c test/test_good.c test/switch_good.c test/test_class.c test/test_func_call.c test/continue.c test/test_struct.c test/test_struct_ptr.c test/test_virtual.c; do
